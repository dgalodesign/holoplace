...
/**
 * Reads the selected world region into a {@link LitematicaSchematicWriter.Region} — everything in the
 * box, as it is now. Block entities are stored in the format's layout: {@code saveCustomOnly} data
 * plus region-relative {@code x}/{@code y}/{@code z} ints, no vanilla id.
 */
