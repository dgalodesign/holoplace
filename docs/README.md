...
| [`launch-checklist.md`](launch-checklist.md) | Tareas concretas para el primer lanzamiento (0.1.0): bloqueantes, recomendable, y qué queda para 0.2.0 | Antes de publicar |
